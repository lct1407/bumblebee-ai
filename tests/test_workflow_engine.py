"""Test: WorkflowEngine â€” YAML loading + LangGraph StateGraph build."""
from pathlib import Path
import pytest

from bumblebee.services.control.workflow_engine import WorkflowEngine

WORKFLOWS_DIR = Path(__file__).parent.parent / "bumblebee" / "workflows"
