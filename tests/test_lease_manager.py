"""Test: ScopeLease â€” acquire / conflict / release / heartbeat."""
import uuid
import pytest
from sqlalchemy import select

from bumblebee.models.scope_lease import ScopeLease, LeaseStatus
from bumblebee.models.agent_session import AgentSession
from bumblebee.models.issue import Issue
from bumblebee.services.dispatch.lease_manager import (
    acquire_lease,
    release_lease,
    heartbeat_lease,
    _globs_overlap,
...
async def test_conflict_blocks_second_acquire(clean_db):
    ...
    # Second tries overlapping scope â€” should fail
