...
from src.models.knowledge_entry import KnowledgeEntry, KnowledgeCategory
...
SAMPLE_ISSUES = [
    ...
    },
    {
        ...
        "acceptance_criteria": (
            "User can click 'Sign in with Google' → redirected to Google → returns with JWT cookie set. "
