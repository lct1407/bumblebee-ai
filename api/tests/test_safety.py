...
from src.models.agent_session import AgentSession, FailureReason
from src.models.issue import Issue
from src.services.safety.budget_enforcer import (
    BudgetExceeded,
    check_session_budget,
    estimate_cost,
)
from src.services.safety.failure_classifier import classify_failure, recommend_mitigation
from src.services.safety.loop_detector import detect_loop
...
async def test_loop_detector_no_loop(clean_db):
    ...
    # Few distinct tool calls — no loop
